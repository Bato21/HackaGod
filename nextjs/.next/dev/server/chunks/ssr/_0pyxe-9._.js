...
function ReportesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('news_events').select('id,title,summary,corruption_types,severity,published_at,source_name,url').eq('verified', true).order('published_at', {
            ascending: false
        }).limit(60).then(({ data })=>{
...
//# sourceMappingURL=_0pyxe-9._.js.map