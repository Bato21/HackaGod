...
function CountryPanel({ iso3, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CountryPanel.useEffect": ()=>{
            ...
            setData(null);
            ({
                "CountryPanel.useEffect": async ()=>{
                    const { data: country } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('countries').select('*').eq('iso_alpha3', iso3).single();
                    if (!country) {
                        setLoading(false);
                        return;
                    }
                    const [{ data: score }, { data: signals }, { data: threads }] = await Promise.all([
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('iea_scores').select('*').eq('country_id', country.id).order('period', {
                            ascending: false
                        }).limit(1).maybeSingle(),
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('risk_signals').select('*').eq('country_id', country.id).eq('active', true).order('severity', {
                            ascending: false
                        }).limit(5),
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('forum_threads').select('id,title,alert_level,reply_count').eq('country_id', country.id).order('created_at', {
                            ascending: false
                        }).limit(3)
                    ]);
                    setData({
...
function AtlasPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AtlasPage.useEffect": ()=>{
            ;
            ({
                "AtlasPage.useEffect": async ()=>{
                    const { data: c } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('countries').select('id,iso_alpha3,name_es,latitude,longitude,flag_emoji').eq('active', true);
                    if (!c?.length) {
                        setLoading(false);
                        return;
                    }
                    const { data: iea } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('iea_scores').select('country_id,iea_score').in('country_id', c.map({
                        "AtlasPage.useEffect": (x)=>x.id
                    }["AtlasPage.useEffect"])).order('period', {
                        ascending: false
                    });
                    const latest = {};
                    iea?.forEach({
                        "AtlasPage.useEffect": (r)=>{
                            if (!(r.country_id in latest)) latest[r.country_id] = r.iea_score;
                        }
                    }["AtlasPage.useEffect"]);
                    setCountries(c.map({
                        "AtlasPage.useEffect": (x)=>({
                                iso3: x.iso_alpha3,
                                name: x.name_es,
                                flag: x.flag_emoji ?? '',
                                lat: x.latitude ?? 0,
                    ...
                    }["AtlasPage.useEffect"]).sort({
                        "AtlasPage.useEffect": (a, b)=>(a.iea ?? 999) - (b.iea ?? 999)
                    }["AtlasPage.useEffect"]));
                    setLoading(false);
                }
            })["AtlasPage.useEffect"]();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LeafletMap, {
                        ...
                        severityColor: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$design$2d$tokens$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["severityColor"]
                    }, void 0, false, {
                        fileName: "[project]/app/(app)/atlas/page.tsx",
                        lineNumber: 165,
                        columnNumber: 9
...
_s(AtlasPage, "XNmBtG/p1ls6bauUoQ3ZjJQNKdY=");
_c1 = AtlasPage;
var _c, _c1;
...
//# sourceMappingURL=_0e9l4zu._.js.map